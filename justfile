...
image:
  docker build -t thespian:rust -f Dockerfile.rust .
...
standalone_container:
  ...
  docker run -d -p 6379:6379 -e OTEL_BACKEND_ADDRESS -e LOKI_ADDRESS -e PORT -e CONFIG_JSON --network instrumentation_thespian_instrumentation --name standalone_thespian thespian:rust
...
call_service_container:
  ...
  docker run -d -p 6380:6380 -e OTEL_BACKEND_ADDRESS -e LOKI_ADDRESS -e PORT -e CONFIG_JSON --network instrumentation_thespian_instrumentation --name call_service_thespian thespian:rust
